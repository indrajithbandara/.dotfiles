...
;; TODO: Ash - Bitbucket PR integration
(add-to-list 'load-path "~/helm-ash")
(require 'helm-ash)
(global-set-key (kbd "C-x c C-r") 'helm-ash-inbox)

(global-set-key (kbd "C-x c f") 'mocha-test-at-point)
(global-set-key (kbd "C-x c t") 'mocha-test-file)
...
;; (add-to-list 'load-path "~/.emacs.d/site-lisp/gh.el/gh.el")
(require 'gh-gist)

;; (add-to-list 'load-path "~/.emacs.d/site-lisp/gist.el/gist.el")
(require 'gist)
